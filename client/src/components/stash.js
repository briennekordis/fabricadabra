...
function ViewStash() {
    ...
    return (
      <Modal show={addShow} onHide={function () { handleCloseAdd() }}>
        ...
        <Modal.Footer>
          ...
          <Button id="confirmButton" onClick={function () { addFabric(modalInfo.FabricId) }}>Save changes</Button>
        </Modal.Footer>
      </Modal>
    );
  }
  ...
  return (
    <>
      <div id="stashOps">
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-plus-square-fill" viewBox="0 0 16 16" type="button" id="addFabricIcon" onClick={() => { showAdd() }}>
